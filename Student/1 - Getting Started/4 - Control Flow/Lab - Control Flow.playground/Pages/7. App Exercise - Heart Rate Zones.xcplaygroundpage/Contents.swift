...
switch currentHR {
case 100...120:
    print("You are in the very light zone. Activity in this zone helps with recover")
case 121...140:
    print("You are in the light zone. Activity in this zone helps improve basic endurance and fat burning")
case 141...160:
    print("You are in the moderate zone. Activity in this zone helps improve basic endurance and fat burning")
case 161...180:
    print("You are in the hard zone. Activity in this zone increases maximum performance capacity for shoerter sessions")
case 181...200:
    print("You are in the maximum zone. Activity in this zone helps fit athletes develop speed")
default:
    print("You are too high. Slow it down!")
}
/*:
