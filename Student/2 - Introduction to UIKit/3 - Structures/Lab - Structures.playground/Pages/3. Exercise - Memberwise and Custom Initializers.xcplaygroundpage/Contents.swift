...
let favoriteBook = Book(title: "Michael Vey", author: "Paul Evens", pages: 300, price: 20.00)
print("My favorite book is \(favoriteBook.title) writen by \(favoriteBook.author) and it has \(favoriteBook.pages) pages and it cost \(favoriteBook.price)")
...
//var height = Height(heightInInches: 5)
//height.heightInCentimeters\
//var height = Height(heightInCentimeters: 1)
