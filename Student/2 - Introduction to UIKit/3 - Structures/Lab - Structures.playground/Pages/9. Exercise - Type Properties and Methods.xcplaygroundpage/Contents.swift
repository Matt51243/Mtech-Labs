...
struct User {
    ...
    static var currentUser = User(userName: "Matt", email: "My email", age: 17)
    
    static func logIn(user: User) {
        currentUser = user
        print("The user \(user.userName) is now logged in")
    }
...
let anotherUser = User(userName: "Reece", email: "reece@reeces.com", age: 68)
