...
var Matthew = User(name: "Matthew", age: 17, height: 5.7, weight: 130, activityLevel: 10)
print("Hi my name is \(Matthew.name) and im \(Matthew.age) years old. Im \(Matthew.height) and i weigh \(Matthew.weight) pounds and my activity level is \(Matthew.activityLevel) out of 10")
/*:
...
var inches = Distance(feet: 3.28084)
print(inches.meters)
/*:
