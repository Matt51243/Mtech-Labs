...
print(calculateArea(x: 3.0, y: 1.0) as Any)
print(calculateArea(x: -1.0, y: 1.0))
...
print(add(a: 10, b: 5) as Any)
print(add(a: 0, b: nil) as Any)
/*:
...
print(createUser()?.firstName as Any)
print(createUser()?.lastName as Any)
print(createUser()?.age as Any)
