...
//print("The value of foo is \(foo)")
print("becuase foo is only avalible in the loop")
...
print("'x' is avalible outside of the loop so its reffrencing the var x")
...
print(greeting(greeting: "hey there", name: "sara"))
